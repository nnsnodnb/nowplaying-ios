...
extension Reactive where Base: SKPaymentQueue {
    ...
    func restoreCompletedTransactions() -> Observable<SKPaymentQueue> {
    ...
    func add(product: SKProduct, shouldVerify: Bool) -> Observable<SKPaymentTransaction> {
    ...
    func start(downloads: [SKDownload]) -> Observable<SKDownload> {
