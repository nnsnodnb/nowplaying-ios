...
/// If your oauth provider doesn’t provide <code>oauth_verifier</code>
...
/// cases, like with Imgur, the url needs to be encoded only once and this value needs to be set to <code>false</code>.
@property (nonatomic) BOOL encodeCallbackURLQuery;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull consumerKey;
@property (nonatomic, readonly, copy) NSString * _Nonnull consumerSecret;
...
/// <code>data</code> converted to string using data encoding
