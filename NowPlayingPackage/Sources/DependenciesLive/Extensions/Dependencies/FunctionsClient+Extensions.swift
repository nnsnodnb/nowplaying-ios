//
//  FunctionsClient+Extensions.swift
//  NowPlayingPackage
//
...
public extension FunctionsClient {
  fileprivate static let functions = Functions.functions(region: "asia-northeast1")

  static func firebase(endpointURLString: String = "https://asia-northeast1-nowplayingios.cloudfunctions.net") -> Self {
    .init(
