...
let package = Package(
  ...
  dependencies: [
    .package(url: "https://github.com/MasterJ93/ATProtoKit.git", from: "0.33.3"),
    ...
    .package(url: "https://github.com/RevenueCat/purchases-ios-spm.git", from: "5.86.0"),
    ...
    .package(url: "https://github.com/googleads/swift-package-manager-google-mobile-ads.git", from: "13.8.0"),
