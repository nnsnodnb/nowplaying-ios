...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/RevenueCat/purchases-ios-spm.git", from: "5.90.2"),
    ...
    .package(url: "https://github.com/googleads/swift-package-manager-google-mobile-ads.git", from: "13.10.0"),
